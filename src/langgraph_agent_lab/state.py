...
class AgentState(TypedDict, total=False):
    ...
    # Student-added fields. All are overwrite (latest value wins) — they hold the
    # *current* decision/state, not an append-only history, so no reducer is used.
    evaluation_result: str  # "success" | "needs_retry" — drives route_after_evaluate
    pending_question: str  # clarification question asked back to the user
